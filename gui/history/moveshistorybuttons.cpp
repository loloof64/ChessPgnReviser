...
loloof64::MovesHistoryButtons::MovesHistoryButtons(QWidget *parent) : QWidget(parent)
{
    ...
    _gotoStartButton = new QPushButton(QIcon(QPixmap(":/icons/previous.svg")), tr(""), this);
    _gotoStartButton->setToolTip(tr("Goto start"));

    _gotoPreviousButton = new QPushButton(QIcon(QPixmap(":/icons/left.svg")), tr(""), this);
    _gotoPreviousButton->setToolTip(tr("Goto previous"));

    _gotoNextButton = new QPushButton(QIcon(QPixmap(":/icons/right.svg")), tr(""), this);
    _gotoNextButton->setToolTip(tr("Goto next"));

    _gotoEndButton = new QPushButton(QIcon(QPixmap(":/icons/next.svg")), tr(""), this);
